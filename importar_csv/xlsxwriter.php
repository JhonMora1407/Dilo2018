...
class XLSXWriter
{
	...
	protected function initializeSheet($sheet_name, $col_widths=array(), $auto_filter=false, $freeze_rows=false, $freeze_columns=false )
	{
		...
		$sheet->file_writer->write('<?xml version="1.0" encoding="windows-1252" standalone="yes"?>' . "\n");
	...
	protected function writeStylesXML()
	{
		...
		$file->write('<?xml version="1.0" encoding="windows-1252" standalone="yes"?>'."\n");
	...
	{
		$app_xml="";
		$app_xml.='<?xml version="1.0" encoding="windows-1252" standalone="yes"?>'."\n";
	...
	{
		$core_xml="";
		$core_xml.='<?xml version="1.0" encoding="windows-1252" standalone="yes"?>'."\n";
	...
	{
		$rels_xml="";
		$rels_xml.='<?xml version="1.0" encoding="windows-1252"?>'."\n";
	...
	protected function buildWorkbookXML()
	{
		$i=0;
		$workbook_xml="";
		$workbook_xml.='<?xml version="1.0" encoding="windows-1252" standalone="yes"?>'."\n";
	...
	protected function buildWorkbookRelsXML()
	{
		$i=0;
		$wkbkrels_xml="";
		$wkbkrels_xml.='<?xml version="1.0" encoding="windows-1252"?>'."\n";
	...
	{
		$content_types_xml="";
		$content_types_xml.='<?xml version="1.0" encoding="windows-1252"?>'."\n";
...
class XLSXWriter_BuffererWriter
{
	...
	protected static function isValidUTF8($string)
	{
		...
		{
			return mb_check_encoding($string, 'windows-1252') ? true : false;
		}
